Installing create-react-native-app globally as below removes the warnings.

npm install -g create-react-native-app

Thanks @ajostergaard, you're right (I have updated my comment). Apparently I did install react-native-scripts separately. It's needed as being used in NavigationPlayground/package.json.
